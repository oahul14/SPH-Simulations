...
int main(void)
{
	...
	domain.place_points(domain.min_x,domain.max_x, "shoaling");				//places initial points - will need to be modified to include boundary points and the specifics of where the fluid is in the domain
